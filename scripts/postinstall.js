...
function parsePackageJson() {
	if (!(process.arch in ARCH_MAPPING)) {
		console.error(
			'Installation is not supported for this ARCH: ' + process.arch
		)
		return
	}
	...
	if (!(process.platform in PLATFORM_MAPPING)) {
		console.error(
			'Installation is not supported for this OS: ' + process.platform
		)
		return
	}
...
async function uninstall(callback) {
	...
	console.info('Uninstalled cache-me-ousside successfully')
